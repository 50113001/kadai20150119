...
public class FrameSystemView extends Frame implements ActionListener,WindowListener
 {
	...
	private TextField text3 = new TextField("", 20);
	//M/M/1óp
	private TextField m1 = new TextField("",10);
	private TextField m2 = new TextField("",10);
	private TextField m3 = new TextField("", 20);
	private Button bm = new Button("M/M/1");
	//M/M/Sóp
	private TextField l1 = new TextField("", 8);
	private TextField l2 = new TextField("", 8);
	private TextField l3 = new TextField("", 8);
	private TextField l4 = new TextField("", 10);
	private Button bl = new Button("M/M/S");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == button1){
		  ...
		  text3.setText(String.valueOf(clib.getPlus()));
			...
			double lambda = Double.parseDouble(l1.getText());
		    double mu = Double.parseDouble(l2.getText());
		    int s = Integer.parseInt(l3.getText());
		    MMS_lib mms = new MMS_lib(lambda, mu,s);
			l4.setText(String.valueOf(mms.getL()));
		}
	}
